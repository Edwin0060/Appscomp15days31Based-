...
""",
    ...
    "data": [
        ...
        'views/hospital_extra.xml',
        'views/res_partner.xml',
        'views/drug_request.xml',
        'views/hospital_room_view.xml',
        'views/patient_discharge_form.xml',
        ...
        'report/patient_discharge_report.xml',
        'report/template_wizard_fitness_reprt_certificate.xml',
    ],
    "author": "BrowseInfo",
