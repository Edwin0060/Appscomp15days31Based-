odoo.define('kot_module.KotOrderReceipt', function(require) {
    'use strict';

    const PosComponent = require('point_of_sale.PosComponent');
    const Registries = require('point_of_sale.Registries');

    class KotOrderReceipt extends PosComponent {
        constructor() {
            super(...arguments);
    ...
    KotOrderReceipt.template = 'KotOrderReceipt';

    Registries.Component.add(KotOrderReceipt);

    return KotOrderReceipt;
});
