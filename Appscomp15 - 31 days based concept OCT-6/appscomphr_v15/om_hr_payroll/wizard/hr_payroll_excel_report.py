...
class HrPayRollExcelReport(models.TransientModel):
    ...
    def action_get_hr_payroll_excel_report(self):
        ...
        if not self.employee_id and not self.department_id and self.selct_month and self.year_master:
            col_1 = 0
            rows += 1
            ...
            for value in payroll:
                ...
                for a in salary_struc.rule_ids:
                    ...
                    col_1 += 1
                    print('lineeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee'  ,col_1 )
                break
            sl_no = 1
            row_pq = row_pq + 1
            col_pq = col_pq + 1
                    ...
                    if self.by_date_range_year_month == 'by_month_year':
                        if self.selct_month == record.date_months:
                            ...
                            if record.employee_id.joining_date:
                                worksheet1.write(row_pq, 3, str(record.employee_id.joining_date), design_8)
                            else:
